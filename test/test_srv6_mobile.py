...
class TestSRv6TMGTP4DWithTEID(VppTestCase):
    """SRv6 T.M.GTP4.D with teid lookup (GTP-U -> SRv6)"""

    @classmethod
    def setUpClass(cls):
        super(TestSRv6TMGTP4DWithTEID, cls).setUpClass()
        try:
            cls.create_pg_interfaces(range(2))
            cls.pg_if_i = cls.pg_interfaces[0]
            cls.pg_if_o = cls.pg_interfaces[1]
            ...
            super(TestSRv6TMGTP4DWithTEID, cls).tearDownClass()
            raise
    ...
    def test_srv6_mobile(self):
        ...
        self.vapi.cli("sr policy add bsid D4:: next D2:: next D3::")
        # self.vapi.cli(
        # "sr policy add bsid D5:: behavior t.m.gtp4.d D4::/32 v6src_prefix C1::/64 nhtype ipv6 fib-table 0 teid 100/32")
