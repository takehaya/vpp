...
struct sr_table *sr_table_new (u8 family, u8 max_keylen,
			       sr_table_del_cb_t del);
...
struct sr_table_node *sr_table_node_new (struct sr_table *table, u8 *key,
					 u8 keylen);
struct sr_table_node *sr_table_node_get (struct sr_table *table, u8 *key,
					 u8 keylen);

struct sr_table_node *sr_table_node_lookup (struct sr_table *table, u8 *key,
					    u8 keylen);
struct sr_table_node *sr_table_node_match (struct sr_table *table, u8 *key,
					   u8 keylen);
